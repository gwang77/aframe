...
<div class="main">
    ...
    <div class="row">
        ...
        <a href="${pageContext.request.contextPath}/auditLog/auditLogSearch">Audit Log View</a><br>
        <a href="${pageContext.request.contextPath}/acm/user/userSearch">User Admin</a><br>
        <a href="${pageContext.request.contextPath}/acm/role/roleSearch">Role Admin</a><br>
        <a href="${pageContext.request.contextPath}/acm/permission/permissionSearch">Permission Admin</a><br>
    </div>
</div>
</body>
</html>