...
INSERT INTO `tbl_acm_application` (`id`,`app_id`,`name`,`base_url`,`locked`,`create_by`,`create_dt`,`update_by`,`update_dt`,`version`) VALUES 
 (1,'acm','ACM','','N','acm','2016-10-17 10:10:39','acm','2016-12-05 15:38:55',4);
...
INSERT INTO `tbl_acm_user` (`id`,`username`,`password`,`salt`,`user_type`,`realname`,`staff_id`,`id_number`,`sex`,`birth_date`,`tel`,`email`,`locked`,`reg_id`,`create_by`,`create_dt`,`update_by`,`update_dt`,`version`) VALUES 
 (1,'admin','d0d752c1c88f6fdb9a41ced5a203f5ff','18f1a8ae3e63cd4b24faa88d3d560f94','P','admin','','',NULL,'2016-05-18','12345678918','123456@139.com','N',0,'SYSTEM','2016-02-01 00:00:00','SYSTEM','2016-06-15 17:32:08',25);
...
INSERT INTO `tbl_acm_user_role` (`id`,`user_id`,`role_id`,`create_by`,`create_dt`,`update_by`,`update_dt`,`version`) VALUES 
 (1,1,1,'acm','2016-12-21 15:00:22',NULL,NULL,1);
...
INSERT INTO `tbl_comm_menu` (`id`,`caption`,`style`,`url`,`permission`,`available`,`seq_no`,`parent_id`,`create_by`,`create_dt`,`update_by`,`update_dt`,`version`) VALUES 
 (1001,'menu_acm','NULL','NULL','NULL','Y',0,0,'SYSTEM','2017-02-03 12:53:40',NULL,NULL,1),
